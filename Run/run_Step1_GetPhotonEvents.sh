...
#mc16apath='/eos/atlas/atlascerngroupdisk/phys-susy/2L2J-ANA-SUSY-2018-05/SusySkim2LJets/v1.3/JETM4_lowpt/JETM4_mc16a/JETM4_mc16a_SEPT12_v4/merged/'
#
#
##for sample in SinglePhoton222
#for sample in SinglePhoton222 SinglePhoton211
##for sample in Vgamma
#do
...
#mc16cdpath='/eos/atlas/atlascerngroupdisk/phys-susy/2L2J-ANA-SUSY-2018-05/SusySkim2LJets/v1.3/JETM4_lowpt/JETM4_mc16cd/JETM4_mc16cd_SEPT12_v4/merged/'
...
mc16epath='/eos/atlas/atlascerngroupdisk/phys-susy/2L2J-ANA-SUSY-2018-05/SusySkim2LJets/v1.3/JETM4_lowpt/JETM4_mc16cd/JETM4_mc16cd_SEPT12_v4/merged/'

echo "Doing JETM4 mc16e Vgamma" 
rm -f logfiles/run_Step1_GetPhotonEvents_JETM4_mc16e_Vgamma.log
root -l -b -q '../Root/GetPhotonEvents.C+("Vgamma_merged_processed","gmc16e","'${mc16epath}'",0,"Vgamma_NoSys")' > logfiles/run_Step1_GetPhotonEvents_JETM4_mc16e_Vgamma.log 2>&1 &
