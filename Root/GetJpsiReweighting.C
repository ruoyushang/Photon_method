...
void GetJpsiReweighting(string ch, int isData, string year) {
	...
	for (Long64_t i=0;i<nentries;i++) {
		...
		ptrw_2j30 = gr_2j30_ptrw_correction->Eval(Jpsi_pt);
		ptsmrw_2j30 = gr_2j30_ptsmrw_correction->Eval(Jpsi_pt_smear);
		etrw_2j30 = gr_2j30_etrw_correction->Eval(Jpsi_pt);
		etsmrw_2j30 = gr_2j30_etsmrw_correction->Eval(Jpsi_et_smear);
		...
		ptrw_ht200 = gr_ht200_ptrw_correction->Eval(Jpsi_pt);
		ptsmrw_ht200 = gr_ht200_ptsmrw_correction->Eval(Jpsi_pt_smear);
		etrw_ht200 = gr_ht200_etrw_correction->Eval(Jpsi_pt);
		etsmrw_ht200 = gr_ht200_etsmrw_correction->Eval(Jpsi_et_smear);
		...
		ptrw_ht400 = gr_ht400_ptrw_correction->Eval(Jpsi_pt);
		ptsmrw_ht400 = gr_ht400_ptsmrw_correction->Eval(Jpsi_pt_smear);
		etrw_ht400 = gr_ht400_etrw_correction->Eval(Jpsi_pt);
		etsmrw_ht400 = gr_ht400_etsmrw_correction->Eval(Jpsi_et_smear);
		...
		ptrw_ht1200 = gr_ht1200_ptrw_correction->Eval(Jpsi_pt);
		ptsmrw_ht1200 = gr_ht1200_ptsmrw_correction->Eval(Jpsi_pt_smear);
		etrw_ht1200 = gr_ht1200_etrw_correction->Eval(Jpsi_pt);
		etsmrw_ht1200 = gr_ht1200_etsmrw_correction->Eval(Jpsi_et_smear);
		...
		ptrw_srhigh = gr_srhigh_ptrw_correction->Eval(Jpsi_pt);
		ptsmrw_srhigh = gr_srhigh_ptsmrw_correction->Eval(Jpsi_pt_smear);
		etrw_srhigh = gr_srhigh_etrw_correction->Eval(Jpsi_pt);
		etsmrw_srhigh = gr_srhigh_etsmrw_correction->Eval(Jpsi_et_smear);
